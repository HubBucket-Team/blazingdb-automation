...
gcloud beta container --project "$project" clusters create "$name" --zone "$zone" --username "admin" --cluster-version "1.11.8-gke.6" --machine-type "n1-standard-4" --accelerator "type=nvidia-tesla-t4,count=$num_gpus" --image-type "COS" --disk-type "pd-standard" --disk-size "50" --scopes "https://www.googleapis.com/auth/devstorage.read_only","https://www.googleapis.com/auth/logging.write","https://www.googleapis.com/auth/monitoring","https://www.googleapis.com/auth/servicecontrol","https://www.googleapis.com/auth/service.management.readonly","https://www.googleapis.com/auth/trace.append" --num-nodes "$num_nodes" --enable-cloud-logging --enable-cloud-monitoring --no-enable-ip-alias --network "projects/blazingdb-system-automation/global/networks/default" --subnetwork "projects/blazingdb-system-automation/regions/us-west1/subnetworks/default" --addons HorizontalPodAutoscaling,HttpLoadBalancing --enable-autoupgrade --enable-autorepair
