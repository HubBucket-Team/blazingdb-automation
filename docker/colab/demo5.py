...
bc.create_table('data_00', '/blazingsql/data/cancer_data_00.csv', delimiter=',', dtype=column_types, names=column_names)

# Parquet
column_names = ['perimeter', 'area', 'smoothness', 'compactness']
bc.create_table('data_01_parquet', '/blazingsql/data/cancer_data_01.parquet')
...
column_types = ['float32', 'float32', 'float32', 'float32']
gdf_02= cudf.read_csv('/blazingsql/data/cancer_data_02.csv',delimiter=',', dtype=column_types, names=column_names)
