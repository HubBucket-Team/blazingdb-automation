...
if [ $blazingdb_orchestrator_enable == true ]; then
    ...
    echo "CUDACXX=/usr/local/cuda/bin/nvcc cmake -DCMAKE_BUILD_TYPE=$blazingdb_orchestrator_build_type  -DBLAZINGDB_DEPENDENCIES_INSTALL_DIR=$workspace_dir/dependencies/ -DBLAZINGDB_PROTOCOL_INSTALL_DIR=$blazingdb_protocol_install_dir -DBLAZINGDB_COMMUNICATION_INSTALL_DIR=$blazingdb_communication_install_dir .."
