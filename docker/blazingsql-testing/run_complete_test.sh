...
#DEVELOP MODE
nvidia-docker run --name bzsqlcontainer -d -p 8884:8888 -p 8887:8787 -p 8886:8786 -p 9002:9001  -v $HOME/.ssh/:/home/$user/.ssh/ -v $local_workdir/run_e2e.sh:/tmp/run_e2e.sh -v $workdir/:$home_user -ti blazingsqltest  bash
#JENKINS MODE
